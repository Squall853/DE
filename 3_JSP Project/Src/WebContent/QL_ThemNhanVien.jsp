...
<div class="container-fluid">
	...
	<div class="col-md-9">
		<h4 class="text-center" style="line-height:40px;color:white; background:gray">Thêm Nhân Viên</h4>
	</div>
	<div class="col-md-9" align="center">
		<form action="addNhanVien.jsp" method="post">	
		<table >
				...
				<tr valign="top">
					...
					<td><input class="form-control" type="text" name="HoNV"/></td>
				</tr>
				<tr valign="top">
				...
				<tr valign="top">
					...
					<td><input class="form-control" type="text" name="CongViec"/></td>
				</tr>
				<tr valign="top">
					<td><label>Ngày Vào Làm: </label></td>
					<td><input class="form-control" type="date" name="NgayVaoLam"/></td>
				</tr>
				<tr>
					<td></td>
					<td align="left">

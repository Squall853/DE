...
<div class="container-fluid">
	...
	<div class="col-md-9" align="center">
		<form  method="post" action="addCTHD.jsp">	
		<table >

				<tr valign="top">
					<td><label>Mã hóa đơn: </label></td>
					
						<td><input class="form-control" type="text" name="MaHD" value="<%=session.getAttribute("MaHD") %>"></td>
					
				</tr>
		
				<tr valign="top">
					<td><label>Mã Sản Phẩm:</label></td>
					<td><input class="form-control" type="text" name="MaHang" required/></td>

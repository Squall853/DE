...
<div class="container-fluid">
	<div class="col-md-3">
		...
		<ul class="list-group">
			...
			<li class="list-group-item active2"><a href="NV_QuanLyMatHang.jsp" style="color:white">Quản Lý Mặt Hàng</a></li>
			...
			<tbody>
				...
				<c:forEach var="row" items="${result.rows}">
					<tr align="center">
						...
						<td><a href="NV_ChiTietMH.jsp?MaHang=${row.MaHang}">Xem mô tả</a></td>
						...
						<!--  <td><a href="NV_ChinhSuaTTMH.jsp?MaHang=${row.MaHang}">Sửa</a></td>
						<td><a href="NV_XoaSanPham.jsp?MaHang=${row.MaHang}">Xóa</a></td>-->

...
<div class="container-fluid">
	<div class="col-md-3">
		...
		<ul class="list-group">
			...
			<li class="list-group-item active2"><a href="KH_ChinhSua.jsp" style="color:white">Chỉnh Sửa Thông Tin</a></li>
	...
	<div class="col-md-9" >
		...
		<form method="post" action="ChinhSua_TTKH.jsp">
				<input type="hidden" name="TaiKhoan" value="<%=session.getAttribute("TaiKhoan")%>">
			<div class="form-inline">
				<label class="fieldinput col-sm-3">Họ: </label>
				<input type="text" name="Ho" class="form-control" value="${row.Ho}" disabled>
			</div><br>
						<div class="form-inline">
				<label class="fieldinput col-sm-3">Tên: </label>
				<input type="text" name="TenKH" class="form-control" value="${row.Ten}" disabled>
			</div><br>

...
<body style="min-height:650px">
		...
		select taikhoan.Ho,taikhoan.Ten,taikhoan.TaiKhoan,taikhoan.Email,taikhoan.SDT
		from taikhoan inner join giohang on taikhoan.TaiKhoan=giohang.TaiKhoan
		group by taikhoan.Ho,taikhoan.Ten,taikhoan.Email,taikhoan.SDT;
...
<div class="container-fluid">
	<div class="col-md-3">
		...
		<ul class="list-group">
			...
			<li class="list-group-item active2"><a href="NV_QuanLyDatHang.jsp" style="color:white">Quản Lý Đặt Hàng</a></li>
		</ul>
	</div>
	<div class="col-md-9">
		<h4 class="text-center" style="line-height:40px;color:white; background:black">Quản Lý Đặt Hàng</h4>
	</div>

	<div class="col-md-9">
		<h4 class="text-center" style="line-height:40px;color:white; background:gray">Danh Sách Đặt Hàng</h4>
	</div>
	<div class="col-md-9">
		<table class="table table-bordered table-striped" >
			<thead >
				<tr >
					...
					<th class="center">Chi tiết Đặt Hàng</th>
			...
			<tbody>
				<c:forEach var="row" items="${result.rows}">
					<tr align="center">
						<td><c:out value="${row.Ho} ${row.Ten}"></c:out></td>
						<td><c:out value="${row.TaiKhoan }"></c:out></td>						
						<td><c:out value="${row.Email}" ></c:out></td>
						<td><c:out value="${row.SDT}"></c:out></td>
						
						<td>
							<a  href="NV_QLChiTietDatHang.jsp?TaiKhoan1=${row.TaiKhoan }">Chi tiết</a>

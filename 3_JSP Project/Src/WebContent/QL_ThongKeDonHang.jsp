...
<body style="min-height:650px">
		...
		select hoadon.MaHD,hoadon.NgayLap,sum(capnhatcthd.ThanhTien) as TongTien
		from hoadon join capnhatcthd on hoadon.MaHD=capnhatcthd.MaHD
		where month(NgayLap)=<%=session.getAttribute("Thang")%>
			and year(NgayLap)=<%=session.getAttribute("Nam")%>
...
<div class="container-fluid">
	<div class="col-md-3">
		...
		<ul class="list-group">
			...
			<li class="list-group-item active2"><a href="QL_ThongKeDonHang.jsp" style="color:white">Thống Kê Đơn Hàng</a></li>
	...
	<div class="col-md-9">
		<h4 class="text-center" style="line-height:40px;color:white; background:black">Thống Kê Bán Hàng</h4>
	 		...
	 		<div class="col-sm-4">
	 		 ...
	 		 <div class="col-sm-6">
	 		 <form action="searchDate2.jsp" method="post">

...
<%
	...
	session.setAttribute("TaiKhoan1", taikhoan);
%>
<head>
	<meta charset="utf-8">
...
<body style="min-height:650px">
		...
		<sql:query dataSource="${snapshot}" var="result">
			SELECT *
			from capnhatgiohang
			where TaiKhoan='<%=session.getAttribute("TaiKhoan1") %>'
		</sql:query>
...
<div class="container-fluid">
	...
	<div class="col-md-9">
		<h4 class="text-center" style="line-height:40px;color:white; background:gray">Chi Tiết Đặt Hàng</h4>
	</div>
	<div class="col-md-9">
		<table class="table table-bordered table-striped" >
			<thead >
				<tr >
					...
					<th class="center">Thành tiên</th>
					<th class="center">Ngày mua</th>
					<th class="center">Địa chỉ giao hàng</th>
			...
			<tbody>
				<c:forEach var="row" items="${result.rows}">
					<tr align="center">
						...
						<td><c:out value="${row.NgayMua}"></c:out></td>
						<td><c:out value="${row.DiaChi}"></c:out></td>

...
<div class="container-fluid a">
	...
	<div class="col-md-9">
		<h4 class="text-center" style="line-height:40px;color:white; background:gray">Danh Sách Hàng Nhập</h4>
	</div>
	<div class="col-md-9">
		<table class="table table-bordered table-striped" >
			...
			<c:forEach var="row" items="${result.rows}">
				<tr align="center">
					...
					<td><c:out value="${row.LyDoNhap}"></c:out></td>
					<td><a href="QL_ChiTietNhap.jsp?SoPhieu=${row.SoPhieu}">Chi Tiết	</a></td>
				</tr>
			</c:forEach>
			</tbody>
	...
	<div class="col-md-9 btn-group">
		<div align="center">
			<a href="QL_ThemPhieuNhap.jsp" class="btn btn-primary">Thêm Phiếu Nhập</a>
		</div>
	</div>
</div>

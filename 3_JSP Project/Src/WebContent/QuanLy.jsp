...
<div class="container-fluid">
	<div class="col-md-3">
		...
		<ul class="list-group">
			<li class="list-group-item active2"><a href="QuanLy.jsp" style="color:white">Thông Tin Quản Lý</a></li>
	...
	<div class="col-md-9">
		<h4 class="text-center" style="line-height:40px;color:white; background:black">Thông Tin Quản Lý</h4>

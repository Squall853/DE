...
<%@ taglib uri="http://java.sun.com/jsp/jstl/sql" prefix="sql"%>
 <!DOCTYPE html>
 <%
 	String taikhoan=request.getParameter("TaiKhoan2");
 	session.setAttribute("TaiKhoan2", taikhoan);
 %>
<html lang="en">
<head>
	<meta charset="utf-8">
...
<body style="min-height:650px">
	<sql:setDataSource var="snapshot" driver="com.mysql.jdbc.Driver"
			...
			SELECT *
			from taikhoan 
			where  TaiKhoan='<%=session.getAttribute("TaiKhoan2") %>'; 
...
<div class="container-fluid">
	...
	<div class="col-md-9">
		<h4 class="text-center" style="line-height:40px;color:white; background:black">Chi Tiết Tài Khoản</h4>
	</div>
		<div class="col-md-9">
			...
			<thead>
					<tr>
						<td ><span><strong>Họ và Tên:</strong></span><c:out value="  ${row.Ho} ${row.Ten}"></c:out></td>
					</tr>
					<tr>
					...
					<tr>
						<td ><span><strong>Giới Tính:</strong></span><c:out value="  ${row.GioiTinh}"></c:out></td>
					</tr>
					<tr>
					...
					<tr>
						<td ><span><strong>Ngày Đăng Ký:</strong></span><c:out value="  ${row.NgayDK}"></c:out></td>
					</tr>
					<tr>

...
<body style="min-height:650px">
		...
		<sql:query dataSource="${snapshot}" var="result">
			SELECT nhanvien.TaiKhoan, nhanvien.HoNV, nhanvien.TenNV
			from nhanvien inner join taikhoan on nhanvien.TaiKhoan=taikhoan.TaiKhoan
			 where nhanvien.TaiKhoan='<%=session.getAttribute("TaiKhoan")%>';  
		</sql:query>
<!--Nav-->
...
<div class="container-fluid">
	<div class="col-md-3">
		...
		<ul class="list-group">
			...
			<li class="list-group-item active2"><a href="NV_ChinhSua.jsp" style="color:white">Chỉnh Sửa Thông Tin</a></li>
	...
	<div class="col-md-9"  >
		...
		<form method="post" action="ChinhSua_TTNV.jsp">
				<input type="hidden" name="TaiKhoan" value="<%=session.getAttribute("TaiKhoan")%>">
			<div class="form-inline">
				<label class="fieldinput col-sm-3">Họ </label>
				<input type="text" name="HoNV" class="form-control" value="${row.HoNV}" disabled>
			</div><br>
						<div class="form-inline">
				<label class="fieldinput col-sm-3">Ten </label>
				<input type="text" name="TenNV" class="form-control" value="${row.TenNV}" disabled>
			</div><br>

...
<div class="container-fluid a">
	...
	<div class="col-md-9">
		<h4 class="text-center" style="line-height:40px;color:white; background:black">Quản Lý Nhân Viên</h4>
	</div>
	<div class="col-md-9">
		<h4 class="text-center" style="line-height:40px;color:white; background:gray">Danh Sách Nhân Viên</h4>
	</div>
	<div class="col-md-9">
		<table class="table table-bordered table-striped" >
			...
			<tbody>
				...
				<tr align="center">
					...
					<td><c:out value="${row.MaNV }"></c:out></td>
					<td><c:out value="${row.HoNV }"></c:out></td>
					<td><c:out value="${row.TenNV }"></c:out></td>
					<td><c:out value="${row.TaiKhoan }"></c:out></td>
					<td><a href="QL_ChTietNV.jsp?MaNV=${row.MaNV }">Xem chi tiết</a></td>
	...
	<div class="col-md-9 btn-group">
		<div align="center">
			<a href="QL_ThemNhanVien.jsp" class="btn btn-primary">Thêm Nhân Viên</a>
		</div>
	</div>
</div>

...
<div class="container-fluid a">
	...
	<div class="col-md-9">
		<h4 class="text-center" style="line-height:40px;color:white; background:gray">Danh Sách Tài Khoản</h4>
	</div>
	<div class="col-md-9">
		<table class="table table-bordered table-striped" >
			<thead >
				<tr>
					...
					<th class="center">Loại Tài Khoản</th>
			...
			<tbody>
				...
				<tr align="center">
					...
					<td><c:out value="${row.Ho }"></c:out></td>
					<td><c:out value="${row.Ten }"></c:out></td>
					<td><c:out value="${row.Email }"></c:out></td>
					<td><c:out value="${row.SDT }"></c:out></td>
					<td><c:out value="${row.LoaiTK }"></c:out></td>
					<td><a href="QL_ChiTietTK.jsp?TaiKhoan2=${row.TaiKhoan}">Xem chi tiết</a></td>
	...
	<div class="col-md-9 btn-group">
		<div align="center">
			<a href="QL_ThemTaiKhoan.jsp" class="btn btn-primary">Thêm Tài Khoản</a>
		</div>
	</div>
</div>

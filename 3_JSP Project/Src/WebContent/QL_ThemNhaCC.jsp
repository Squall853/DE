...
<div class="container-fluid">
	...
	<div class="col-md-9">
		<h4 class="text-center" style="line-height:40px;color:white; background:black">Quản Lý Nhà Cung Cấp</h4>
	</div>

	<div class="col-md-9">
		<h4 class="text-center" style="line-height:40px;color:white; background:gray">Thêm Nhà Cung Cấp</h4>
	</div>
	<div class="col-md-9" align="center">
		<form method="post" action="addNhaCC.jsp" >	
		<table cellpadding ="10">
				<tr>
					<td><label>Tên Nhà Cung Cấp: </label></td>
					<td><input class="form-control" type="text" name="TenNhaPP"/></td>
				</tr>
				<tr>

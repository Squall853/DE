...
<div class="container-fluid">
	<div class="col-md-3">
		...
		<ul class="list-group">
			...
			<li class="list-group-item"><a href="QL_QuanLyKhachHang.jsp" style="color:black">Quản Lý Bảo Hành</a></li>
	...
	<div class="col-md-9">
		...
		<div class="col-md-7" style="margin-left:20px">
			<table class="table table-striped" style="font-size:15px">
				<thead>
					<tr>
						<td ><span><strong>Họ và Tên:</strong></span>Ngô Bảo Ninh</td>

					</tr>
					<tr>
						<td><span><strong>Email:</strong></span>baoninh510120@gmail.com</td>
					</tr>
					<tr>
						<td ><span><strong>Số Điện Thoại:</strong></span>01658887735</td>
					</tr>
						<tr>
						<td><span><strong>Ngày Sinh:</strong></span>12/11/1996</td>
					</tr>
					<tr>
						<td><span><strong>Địa Chỉ:</strong></span>Linh Trung, Thủ Đức</td>
					</tr>
				</thead>
			</table>
		</div>

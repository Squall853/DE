...
<div class="container-fluid">
	...
	<div class="col-md-9">
		<h4 class="text-center" style="line-height:40px;color:white; background:gray">Thêm Phiếu Nhập</h4>
	</div>
	<div class="col-md-9" align="center">
		<form method="post" action="addPhieuNhap.jsp" >	
		<table cellpadding ="10">
				<tr>
					<td><label>Số Phiếu: </label></td>
					<td><input class="form-control" type="text" name="SoPhieuNhap"/></td>
				</tr>
				<tr>
					<td><label>Ngày Nhập: </label></td>
					<td><input class="form-control" type="date" name="NgayNhap"/></td>
				</tr>
				<tr>
					<td><label>Lý Do Nhập: </label></td>
					<td><input class="form-control" type="text" name="LyDoNhap"/></td>
				</tr>
				<tr>
					<td></td>
					<td align="left">

...
<div class="container-fluid a">
			...
			<tbody>
				<c:forEach var="row" items="${result.rows}">
					<tr align="center">
						...
						<td><a href="NV_ChiTietKH.jsp?MaKH=${row.MaKH }">Xem chi tiết</a></td>
					
						<!--<td><a href="NV_XoaKhachHang.jsp?MaKH=${row.MaKH }">Xóa</a></td> -->
					</tr>
				</c:forEach>
			</tbody>
		</table>
	...
	<div class="col-md-9 btn-group">
		<div align="center">
			<a href="NV_ThemKhachHang.jsp" class="btn btn-primary">Thêm Khách Hàng<a href=""></a>
		</div>
	</div>
</div>

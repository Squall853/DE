...
<div class="container-fluid">
	<div class="col-md-3">
		...
		<ul class="list-group">
			...
			<li class="list-group-item"><a href="QL_QuanLyBaoHanh.jsp" style="color:black">Quản Lý Bảo Hành</a></li>
	...
	<div class="col-md-9" align="center">
		...
		<table cellpadding ="10">
				...
				<tr valign="top">
					...
					<td><input class="form-control" type="text" placeholder="HĐ2"/></td>
				</tr>
		
				<tr valign="top">
					<td><label>Ngày lập:</label></td>
					<td>
						<input class="form-control" type="text"><title datetime="2016"></title>
					</td>
				...
				<tr>
				<tr valign="top">
					<td><label>Họ tên Quản Lý:</label></td>
					<td><input class="form-control" type="text" /></td>
				</tr>

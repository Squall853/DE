...
<div class="container-fluid">
	...
	<div class="col-md-9">
		<h4 class="text-center" style="line-height:40px;color:white; background:gray">Thêm Sản Phẩm Bảo Hành</h4>
	</div>
	<div class="col-md-9" align="center">
		<form method="post" action="addSanPhamBH.jsp">	
		<table>
				<tr valign="top">
					<td><label>Mã phiếu: </label></td>
					<td><input class="form-control" type="text" name="MaPhieu" /></td>
				</tr>
				<tr valign="top">
				...
				<tr valign="top">
					<td><label>Ngày bảo hành: </label></td>
					<td><input class="form-control" type="date" name="NgayNhan" /></td>
				</tr>

				<tr valign="top">
					<td><label>Ngày trả hàng: </label></td>
					<td><input class="form-control" type="date" name="NgayTra"/></td>
				</tr>
